...
| 5. Transaction Bulk Edit + List Interaction Fixes | Complete | Pending | Fixed bulk picker-to-confirm transitions, wallet conversion default rate, stable selection header mode, multiselect pager locking, and type-filter scroll-to-top. Covers user items 2 and 8. |
...
Phase 5 is implemented and verified. Commit hash pending.
