...
import com.dv.moneym.feature.settings.overview.StoreSettingsPreview
...
// recordPaparazziDebug writes store_<device>_settings.png for the framing script.
...
class StoreScreenshotTest(
    ...
    @Test
    fun store() {
        paparazzi.snapshot(name = "store_${deviceName}_settings") {
