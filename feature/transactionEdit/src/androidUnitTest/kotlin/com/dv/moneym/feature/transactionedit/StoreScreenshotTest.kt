...
// recordPaparazziDebug writes store_<device>_newtx.png for the framing script.
...
class StoreScreenshotTest(
    ...
    @Test
    fun store() {
        paparazzi.snapshot(name = "store_${deviceName}_newtx") {
            StoreTransactionEditPreview()
        }
    }
}
